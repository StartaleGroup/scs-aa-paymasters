...
const ENTRY_POINT_V0_7_JSON_PATH = "../abis/EntryPoint.json";
const SPONSORSHIP_PAYMASTER_JSON_PATH = "../abis/SponsorshipPaymaster.json";
const COUNTER_JSON_PATH = "../abis/TestCounter.json";

// pre determined addresses
// contracts that were deployed by ERC4337 contracts setup
...
function getPaymasterData(validUntil: number, validAfter: number) {
  const data = {
    fundingId: '0x0000000000000000000000000000000000000000' as `0x${string}`, // temporally 0 address
    validUntil,
    validAfter,
    dynamicAdjustment: 0,
  }
