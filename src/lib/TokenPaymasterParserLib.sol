...
library TokenPaymasterParserLib {
    ...
    function parsePaymasterAndData(bytes calldata _paymasterAndData) internal pure returns (IStartaleTokenPaymaster.PaymasterMode mode, bytes calldata modeSpecificData) {
