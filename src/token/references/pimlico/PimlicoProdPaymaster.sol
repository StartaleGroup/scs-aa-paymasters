...
import {UserOperationLib as UserOperationLibV07} from "@account-abstraction/contracts/core/UserOperationLib.sol";
...
import {PimlicoERC20Base, ERC20PaymasterData, ERC20PostOpContext} from "./PimlicoERC20Base.sol";
...
contract SingletonPaymasterV7 is PimlicoERC20Base, IPaymaster {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    ...
    constructor(address _entryPoint, address _owner, address[] memory _signers)
        PimlicoERC20Base(_entryPoint, _owner, _signers)
    {}
